...
public class Cardboard : Spell
{
	...
	public override void ExecuteSpell(Entity _caster, Vector2Int _target)
	{
		...
		BattleInformationManager.Instance.Notifiate(new NotificationProps(_caster, null, false, notificationSprite, spellName, $"{_caster.InstaCat.catName} is hiding in a cardboard."));
	}
}
